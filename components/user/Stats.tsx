  ...
  return (
    <div className="mt-3">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 xs:grid-cols-2 md:grid-cols-4">
        <div
          className="light-border background-light900_dark300 gapl-4
           flex flex-wrap items-center justify-evenly rounded-md border p-6 
        ...
        >
          <div>
            ...
            <p className="bodt-medium text-dark400_light700">Questions</p>
          </div>
          <div>
            <p className="paragraph-semibold text-dark200_light900">
              {formatNumber(totalAnswers)}
            </p>
            <p className="bodt-medium text-dark400_light700">Answers</p>
          </div>
        </div>
        <StatsCard
